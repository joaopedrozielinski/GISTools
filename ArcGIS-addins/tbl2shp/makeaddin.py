"""
This source code is generated by  ESRI ArcGIS's Python add-ins SDK.
This application package all the neccessory files (described in config.xml) into .esriaddin package.
"""
